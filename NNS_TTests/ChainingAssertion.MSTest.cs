...
{
    #region Extensions
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0007:暗黙的な型の使用", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0022:メソッドに式本体を使用する", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0021:コンストラクターに式本体を使用する", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0060:未使用のパラメーターを削除します", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0044:読み取り専用修飾子を追加します", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0003:修飾子を削除", Scope = "member")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("スタイル", "IDE0049:名前を単純化します", Scope = "member")]
